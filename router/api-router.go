	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/api-key-deliveries/:id/resend", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.ResendAPIKeyDelivery)
				...
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.TopUp)
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.RequestEpay)
				selfRoute.POST("/amount", middleware.PersonalAssetWriteAllowed(), controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.RequestStripePay)
				selfRoute.POST("/stripe/amount", middleware.PersonalAssetWriteAllowed(), controller.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", middleware.PersonalAssetWriteAllowed(), controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", middleware.PersonalAssetWriteAllowed(), controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.RequestWaffoPancakePay)
				selfRoute.POST("/aff_transfer", middleware.UserCriticalRateLimit("aff-transfer"), middleware.PersonalAssetWriteAllowed(), controller.TransferAffQuota)
				...
				selfRoute.POST("/checkin", middleware.TurnstileCheck(), middleware.PersonalAssetWriteAllowed(), controller.DoCheckin)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.SubscriptionRequestBalancePay)
			subscriptionRoute.POST("/epay/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.SubscriptionRequestCreemPay)
			subscriptionRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.PersonalAssetWriteAllowed(), controller.SubscriptionRequestWaffoPancakePay)
		}
		...
		adminSiteOptionRoute := apiRouter.Group("/option/site")
		adminSiteOptionRoute.Use(middleware.AdminAuth())
		{
			adminSiteOptionRoute.GET("", controller.GetAdminSiteOptions)
			adminSiteOptionRoute.PUT("", controller.UpdateAdminSiteOption)
		}
		...
		taskRoute := apiRouter.Group("/task")
		{
			...
			taskRoute.POST("/:id/enterprise-resolution", middleware.AdminAuth(), middleware.CriticalRateLimit(), controller.ResolveEnterpriseTaskManualReview)
		}
